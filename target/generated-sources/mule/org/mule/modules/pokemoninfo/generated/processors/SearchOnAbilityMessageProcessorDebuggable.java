...
public class SearchOnAbilityMessageProcessorDebuggable
    extends SearchOnAbilityMessageProcessor
    implements DebugInfoProvider
{


    public SearchOnAbilityMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("level", "Level", (java.lang.String.class), level, muleEvent));

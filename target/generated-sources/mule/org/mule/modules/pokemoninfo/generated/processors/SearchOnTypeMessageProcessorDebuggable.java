...
public class SearchOnTypeMessageProcessorDebuggable
    extends SearchOnTypeMessageProcessor
    implements DebugInfoProvider
{


    public SearchOnTypeMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("typelevel", "Typelevel", (java.lang.String.class), typelevel, muleEvent));
